...
%% Parameters Setting
N=256;                 %Dimension of x
M=1024;                 %dimension of y
mes=1;%0.9;               %damping factor
...
saveas(figure(1), ['H_Unif',num2str(is_GaussAddUnif),'_Disrc',num2str(is_GaussAddDiscrete),'_',num2str(M),'x',num2str(N),'m',num2str(mes),'snr',num2str(snr),'_',num2str(randi(1e5)),'.fig'])